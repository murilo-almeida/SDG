...
// ****************************************************************************
/*
void Hexahedral::Processar_geometria(int nel,
				     const Vertice * vert,
				     const int numv, 
				     const int * VN,
				     int map[],
...
{
  //printf("Hexahedral::Processar_geometria\n");
  ...
  n2=VN[2];
  n3=VN[3];
  // ordenacao dos nos: mesma para Gambit e Gmsh formats
   //  3 -------- 2
   //  |          |
  //   |          |
  //   0 -------- 1
...
// ************************************************************************
/*     OBSOLETA   - Testar sem
       void Hexahedral::make_gbnmap(int n0,int n1,int n2,int n3,
       int ng0,int ng1,int ng2,int ng3,
       int sign0,int sign1,int sign2,int sign3,
       int map[],int sgn[] )
       {
       //printf("Hexahedral::make_gbnmap\n");
       int p=P[0];
       int i;
       int imax,imin;
       int temp;
